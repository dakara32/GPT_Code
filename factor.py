...
class Output:
    ...
    def display_results(self, exist, bench, df_z, g_score, d_score_all, init_G, init_D, top_G, top_D):
        ...
        self.d_title = (f"[D枠 / {N_D} / QAL{int(D_WEIGHTS_EFF['QAL']*100)} YLD{int(D_WEIGHTS_EFF['YLD']*100)} VOL{int(D_WEIGHTS_EFF['VOL']*100)} TRD{int(D_WEIGHTS_EFF['TRD']*100)} / corrM={corrM} / "
